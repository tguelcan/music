...
<div class="flex flex-col h-screen">
	<div class="py-5 bg-gray-light dark:bg-gray-dark fixed inset-x-0 z-50">
		<div class="container flex items-center justify-between">
			...
			<div class="flex items-center space-x-4 sm:space-x-6">
				...
				<SlectTheme />
				<a href="https://github.com/tguelcan/music" target="_blank" aria-label="GitHub repository"
	...
	<div class="bg-primary-dark text-gray-light py-8">
		<div class="container flex justify-between">
			...
			<div class="w-20">
				<a
					...
					target="_blank"
					class="opacity-70 hover:opacity-40"
				>
